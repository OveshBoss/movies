...
BOT_TOKEN = environ.get('BOT_TOKEN', '7672719621:AAFDeHt-uv3F2gx0ZXnrR_QFPO_y279k_A0')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002342243776').split()]                                                                                                                                                                                                                             ').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "Emongodb+srv://technogamerz40msub:ovesh.boss@ovesh.kyhilyo.mongodb.net/?retryWrites=true&w=majority&appName=Ovesh                                                                                                                                                                                               LOG-CHANNEL--1002598899684")
